...
/*  Código de: https://iq.opengenus.org/strassens-matrix-multiplication-algorithm/ 
    ...
    multiplicación de matrices de Strassen, utilizando la técnica de diseño Divide
    y Venceras.
*/

/* 
 * Método para obtener la siguiente potencia de 2
 * @param k: número al que se esta elevando 2 actualmente
...
/*
 * Utilizada para mostrar la matriz final
 * @param matrix: conjunto de vectores que foroman la matriz resultante
...
/* Operación de suma para submatrices*/
...
/* Operación de resta para submatrices*/
...
/* Crea submatrices a partir de las matrices originales y agrupa los resultados en la matriz resultante */
...
/* Revisa el tamaño de las matrices a utilizar y las ajusta si es necesario
 * Define los parametros de la matriz resultante para invocar el método en el que se
 * asginaran los valores
 */
...
/* Revisa el tamaño de la matriz resultante para asegurar que haya sido una multiplicación exitosa */
...
int main()
{
    ...
    cout<<"\nLa complejidad de este algoritmo es O(n^Log7) que se aproxima a O(n^2.8074)"<<endl;
    return 0;
}